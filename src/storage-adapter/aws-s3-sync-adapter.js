...
(function (root, factory) {
  ...
  return (function (options) {
    ...
    function AWSS3SyncAdapter(options) {
      ...
      if (!options) {
        throw new AWSS3SyncAdapterError(
          "No options configured in AWSS3SyncAdapter"
        );
      }
      ...
      if (!options.accessKeyId) {
        throw new AWSS3SyncAdapterError(
          "No accessKeyId property specified in options"
        );
      }

      if (!options.secretAccessKey) {
        throw new AWSS3SyncAdapterError(
          "No secretAccessKey property specified in options"
        );
      }

      if (!options.bucket) {
        throw new AWSS3SyncAdapterError(
          "No bucket property specified in options"
        );
      }
    ...
    AWSS3SyncAdapter.prototype.saveDatabase = function (name, data, callback) {
      ...
      s3.putObject(params, function (err, data) {
        if (err) {
          console.log(
            "AWSS3SyncAdapter.prototype.saveDatabase() Error:",
            err,
            err.stack
          );
    ...
    AWSS3SyncAdapter.prototype.loadDatabase = function (name, callback) {
      ...
      s3.getObject(params, function (err, data) {
        if (err) {
          console.log(
            "AWSS3SyncAdapter.prototype.loadDatabase() Error:",
            err,
            err.stack
          );
          ...
          if (!data.Body) {
            throw new AWSS3SyncAdapterError(
              "Remote load failed, no data found"
            );
          }
          try {
            ...
            console.log(
              "AWSS3SyncAdapter.prototype.loadDatabase() asciiData:",
              lokiDBObj
            );
            return callback(lokiDBObj);
          } catch (e) {
            throw new AWSS3SyncAdapterError(
              "Remote load failed, invalid loki database"
            );
          }
        }
      });
