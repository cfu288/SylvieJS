  ...
  function Lokiwork(Loki, $q, $injector, $window) {
    ...
    function deleteDocument(dbName, collName, doc) {
      ...
      return $q(function (resolve, reject) {
        ...
        _getem("delete_doc", dbName, collName, doc).then(
          function (data) {
            currentDoc = {};
            resolve(data);
          },
    ...
    function deleteCurrentDoc() {
      return $q(function (resolve, reject) {
        _getem("delete_current_doc").then(
          function (data) {
            resolve(data);
          },
          function (data) {
    ...
    function addDocument(dbName, collName, newDoc) {
      return $q(function (resolve, reject) {
        userDbPreference = dbName;
        _getem("create_doc", dbName, collName, "", "", newDoc).then(
          function (data) {
    ...
    function setCurrentDoc(dbName, collName, docName) {
      return $q(function (resolve, reject) {
        userDbPreference = dbName;
        _getem("set_doc", dbName, collName, docName).then(
          function (data) {
            currentDoc.dbName = dbName;
            currentDoc.collName = collName;
            currentDoc.doc = data;
    ...
    function updateCurrentDoc(thekey, thevalue) {
      return $q(function (resolve, reject) {
        if (currentDoc) {
          ...
          reject(
            "you have to set a current doc first, use: setCurrentDoc(dbName, collName, docName)"
          );
        }
      });
    }
    ...
    function getDoc(dbName, collName, docName) {
      return $q(function (resolve, reject) {
        userDbPreference = dbName;
        _getem("get_doc", dbName, collName, docName).then(
          function (data) {
            currentDoc.dbName = dbName;
            currentDoc.collName = collName;
            currentDoc.doc = data;
    ...
    function getCollection(dbName, collName) {
      return $q(function (resolve, reject) {
        userDbPreference = dbName;
        _getem("get_collection", dbName, collName).then(
          function (data) {
    ...
    function removeCollection(dbName, collName) {
      return $q(function (resolve, reject) {
        userDbPreference = dbName;
        _getem("remove_collection", dbName, collName).then(
          function (data) {
            currentColl = {};
            resolve(data);
          },
    ...
    function addCollection(collData) {
      return $q(function (resolve, reject) {
        ...
        _getem("add_collection", userDbPreference, "", "", "", collData).then(
          function (data) {
    ...
    function initialiseAll() {
      return $q(function (resolve, reject) {
        initialiseDbList().then(
          function () {
            function iterate_me() {
              if ($injector.has("json" + dbitems[current_iteration - 1].json)) {
                var setting = $injector.get(
                  "json" + dbitems[current_iteration - 1].json
                );
