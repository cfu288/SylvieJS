...
console.log(
  "## Fully synchronous operations with excessive saving after each operation ##"
);
...
db = setupDatabaseAsync(function () {
  ...
  db.throttledSaveDrain(function () {
    db2 = setupDatabaseAsync(function () {
      ...
      console.log(
        "## Asynchronous operations with excessive saving after each operation ##"
      );
      console.log(
        "Async database are " + (result ? "the same." : "NOT the same!")
      );
      console.log("Execution time (hr): %ds %dms", end[0], end[1] / 1000000);
      console.log("maxThrottledCalls: " + maxThrottledCalls);
    });
